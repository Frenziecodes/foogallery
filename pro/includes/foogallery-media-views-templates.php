...
?>
	...
	<div class="fgi-splash fgi-getting-started-instructions">
		...
		<p><small><?php printf(esc_html__("See the %s for more information.", "foogallery"), $help) ?></small></p>
	</div>
		...
		<div class="fgi-form">
			...
			<label class="fgi-row">
				...
				<span class="fgi-col-input">
					...
					<span class="fgi-input-description">
						<?php printf(esc_html__("For more information on compatibility please see the following links: %s, %s and %s", "foogallery"), $mp4, $webm, $ogg) ?>
					</span>
				</span>
			</label>
		</div>
...
?>
	...
	<p>
		<?php printf(esc_html__("Displaying %s of %s results.", "foogallery"), $offset, $total) ?>
		<# if (data.total !== 1 && data.nextPage !== 0){ #>
			<span class="fgi-query-result-paged">
				...
				<span class="fgi-query-result-load-more"><?php printf(esc_html__("Would you like to %s?", "foogallery"), $load_more) ?></span>
				<span class="fgi-query-result-try-again"><?php printf(esc_html__("An error occurred loading additional results, %s?", "foogallery"), $try_again) ?></span>
			</span>
		<# } #>
	</p>
...
?>
	...
	<# if (data.total === 1){ #>
		<p><?php esc_html_e("Confirm the video is correct and then click the Import button.", "foogallery") ?></p>
	<# } else { #>
		<p><?php printf(esc_html__("Select the videos to import by clicking the thumbnails and then click the Import button, or would you like to %s?", "foogallery"), $import_album) ?></p>
	<# } #>
...
?>
	...
	<# if (data.total === 1){ #>
		<p><?php esc_html_e("Confirm the video is correct and then click the Import button.", "foogallery") ?></p>
	<# } else { #>
		<p><?php printf(esc_html__("Select the videos to import by clicking the thumbnails and then click the Import button, or would you like to %s?", "foogallery"), $import_channel) ?></p>
	<# } #>
...
?>
	...
	<# if (data.total === 1){ #>
		<p><?php esc_html_e("Confirm the video is correct and then click the Import button.", "foogallery") ?></p>
	<# } else { #>
		<p><?php printf(esc_html__("Select the videos to import by clicking the thumbnails and then click the Import button, or would you like to %s?", "foogallery"), $import_playlist) ?></p>
	<# } #>
...
?>
	...
	<# if (data.total === 1){ #>
		<p><?php esc_html_e("Confirm the video is correct and then click the Import button.", "foogallery") ?></p>
	<# } else { #>
		<p><?php printf(esc_html__("Select the videos to import by clicking the thumbnails and then click the Import button, or would you like to %s?", "foogallery"), $import_user) ?></p>
	<# } #>
...
<script type="text/html" id="tmpl-fgi-youtube">
	...
	<div class="fgi-splash fgi-youtube-api-key">
		...
		<p><?php printf(esc_html__("Create a new project in your %s to generate an api key.", "foogallery"), $developers_console) ?></p>
		<div class="button-hero-container">
