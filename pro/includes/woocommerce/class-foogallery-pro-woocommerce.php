	...
	class FooGallery_Pro_Woocommerce {
        ...
        public function attachment_modal_display_tab() { ?>
            <div class="foogallery-img-modal-tab-wrapper" data-tab_id="foogallery-panel-commerce">
                ...
                <label for="foogallery-tab-commerce"><?php esc_html_e('Commerce', 'foogallery'); ?></label>
            </div>
        <?php }
					...
					<section id="foogallery-panel-commerce" class="tab-panel">
						<div class="settings">
							...
							<span class="setting has-description" data-setting="button-url">
								...
								<input type="text" name="foogallery[button-url]" id="attachment-details-two-column-button-url" value="<?php echo esc_url( $modal_data['foogallery_button_url'] ); ?>">
							</span>
							<p class="description">
								...
								<div class="setting-with-buttons">
                                    ...
                                    <div>
                                        <button type="button" class="button button-primary button-small foogallery-media-selector-choose"
                                            ...
                                            data-modal-title="<?php esc_html_e( 'Select Download File', 'foogallery' ); ?>"
                                            data-modal-button="<?php esc_html_e( 'Select File', 'foogallery' ); ?>"
                                            data-modal-multiple="no"><?php esc_html_e( 'Choose', 'foogallery' ); ?>
                                        </button>
