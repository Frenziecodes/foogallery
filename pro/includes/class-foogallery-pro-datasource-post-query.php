		...
		function render_datasource_item( $gallery ) {
            ...
            <div <?php echo $show_container ? '' : 'style="display:none" '; ?>class="foogallery-datasource-item foogallery-datasource-post_query">
                ...
                <div class="foogallery-items-html">
                    <?php echo esc_html__('Post Type : ', 'foogallery'); ?><span id="foogallery-datasource-post-query-gallery_post_type"><?php echo $gallery_post_type; ?></span><br />
	                <?php echo esc_html__('No. Of Posts : ', 'foogallery'); ?><span id="foogallery-datasource-post-query-no_of_post"><?php echo $no_of_post; ?></span><br />
	                <?php echo esc_html__('Excludes : ', 'foogallery'); ?><span id="foogallery-datasource-post-query-exclude"><?php echo $exclude; ?></span><br />
	                <?php echo esc_html__('Link To : ', 'foogallery'); ?><span id="foogallery-datasource-post-query-link_to"><?php echo $link_to; ?></span><br />
                </div>
                <br/>
