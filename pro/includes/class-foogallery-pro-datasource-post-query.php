                        ...
                        <td>
                            <select class="regular-text foogallery_post_query_input" name="post_type"
								...
								foreach ( get_post_types( array( 'public' => true ) ) as $key => $value ) {
									...
									echo '<option value="' . esc_attr( $value ) . '" ' . esc_attr( $selected ) . '>' . esc_html( ucfirst( $value ) ) . '</option>';
								}
								?>
                            </select>
                        </td>
		...
		function render_datasource_item( $gallery ) {
            ...
            <div <?php echo $show_container ? '' : 'style="display:none" '; ?>class="foogallery-datasource-item foogallery-datasource-post_query">
                ...
                <div class="foogallery-items-html">
					<?php echo esc_html__( 'Post Type : ', 'foogallery' ); ?><span id="foogallery-datasource-post-query-gallery_post_type"><?php echo esc_html( $gallery_post_type ); ?></span><br />
					<?php echo esc_html__( 'No. Of Posts : ', 'foogallery' ); ?><span id="foogallery-datasource-post-query-no_of_post"><?php echo esc_html( $no_of_post ); ?></span><br />
					<?php echo esc_html__( 'Excludes : ', 'foogallery' ); ?><span id="foogallery-datasource-post-query-exclude"><?php echo esc_html( $exclude ); ?></span><br />
					<?php echo esc_html__( 'Link To : ', 'foogallery' ); ?><span id="foogallery-datasource-post-query-link_to"><?php echo esc_html( $link_to ); ?></span><br />
				</div>
                <br/>
