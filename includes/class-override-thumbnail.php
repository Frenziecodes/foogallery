            ...
            <div class="foogallery-attachments-list-bar">
                <div class="settings">
                    ...
                    <span class="setting override-thumbnail-preview <?php echo esc_attr( $modal_data['override_class'] ); ?>" data-setting="override-thumbnail-preview">
                        ...
                        <img id="attachment-details-two-column-override-thumbnail-preview" src="<?php echo esc_url( $modal_data['alternate_img_src'] ); ?>" alt="<?php esc_attr_e('Alternate Thumbnail', 'foogallery'); ?>">
                    </span>
