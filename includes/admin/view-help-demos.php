		...
		<a class="fg-thumb"
			...
			<span class="fg-image-wrap">
				<img class="fg-image"
					...
					data-src-fg="<?php echo esc_url( "https://picsum.photos/seed/" . $seed . "/" . $width . "/" . $height ); ?>"
					data-srcset-fg="<?php echo esc_url( "https://picsum.photos/seed/" . $seed . "/" . ( $width * 2 ) . "/" . ( $height * 2 ) . " 2x" ); ?>"
...
<div id="demos_section" class="foogallery-admin-help-section fgah-demo" style="display: none">
	<header>
		...
		<a href="<?php echo esc_url( foogallery_admin_url( 'https://fooplugins.com/foogallery-wordpress-gallery-plugin/demos/', 'help' ) ); ?>" target="_blank" class="foogallery-admin-help-button"><?php esc_html_e( 'More Demos', 'foogallery' ); ?></a>
	</header>
