...
$migrator_link = sprintf(
    '<a href="%s" target="_blank">%s</a>',
    esc_url( 'https://wordpress.org/plugins/foogallery-migrate/' ),
    esc_html__( 'Find out more!', 'foogallery' )
);
?>
<div id="help_section" class="foogallery-admin-help-section">
    ...
    <section class="fgah-feature">
        ...
        <footer>
            <a class="foogallery-admin-help-button-cta" target="_blank" href="<?php echo esc_url( $migrator_url ); ?>"><?php echo esc_html__( 'Install our migrator!', 'foogallery' ); ?></a>
        </footer>
    </section>
    ...
    <section class="fgah-feature foogallery-admin-help-create-demos">
        ...
        <footer class="fgah-created-demos">
            <a class="foogallery-admin-help-button-cta" href="<?php echo esc_url( foogallery_admin_gallery_listing_url() ); ?>"><?php esc_html_e( 'View Galleries', 'foogallery' ); ?></a>
    ...
    <section class="fgah-feature">
        ...
        <div>
            <figure>
                <img width="650" height="552" src="<?php echo esc_url( 'https://assets.fooplugins.com/foogallery/plugin/foogallery-admin-help-create.png' ); ?>" alt="<?php esc_attr_e( 'Create a gallery', 'foogallery' ); ?>" />
            </figure>
            <ol>
    ...
    <section class="fgah-feature fgah-feature-right">
        ...
        <div>
            <figure>
                <img width="556" height="407" src="<?php echo esc_url( 'https://assets.fooplugins.com/foogallery/plugin/foogallery-admin-help-embed.png' ); ?>" alt="<?php esc_attr_e( 'Show off your gallery', 'foogallery' ); ?>" />
            </figure>
            <dl>
