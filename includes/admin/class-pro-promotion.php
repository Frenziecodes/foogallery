...
?>
			<div class="foogallery_template_field_type-promo <?php echo esc_attr( $class ); ?>">
				<div class="foogallery-promo">
					<strong><?php echo esc_html( $plan ); ?> <?php esc_html_e( 'Feature', 'foogallery' ); ?> : <?php echo esc_html( $datasouce_title ); ?></strong>
					<br><br>
					<?php echo esc_html( $datasource_desc ); ?>
					<br><br>
					<?php echo wp_kses_post( $this->build_promo_trial_html( 'datasources', $plan ) ); ?>
					<br><br>
					<a class="button-primary" href="<?php echo esc_url( $this->build_url( $datasource_url_name ) ); ?>" target="_blank"><?php esc_html_e( 'Learn More', 'foogallery' ); ?></a>
					<a class="button-secondary" href="<?php echo esc_url( $this->build_url( 'foogallery-plans' ) ); ?>" target="_blank"><?php esc_html_e( 'Compare Plans', 'foogallery' ); ?></a>
				</div>
			</div>
<?php
		}
