...
$foogallery_justified_classes = foogallery_build_class_attribute_safe( $current_foogallery, 'foogallery-lightbox-' . esc_attr( $lightbox ) );
...
?>
<div <?php echo wp_kses_post( $foogallery_justified_attributes ); ?>>
