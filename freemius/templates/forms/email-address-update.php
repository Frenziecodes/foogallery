...
( function ( $ ) {
	var modalHtml                             =
            ...
            + '                 <p><?php echo wp_kses_post( sprintf(
                                    ...
                                    sprintf( '<strong>%s</strong>', esc_html( $current_email_address ) ),
	...
	function registerEventHandlers() {
		...
		$modal.on( 'click', '.fs-modal-footer .button-update', function ( evt ) {
            ...
            if ( previousEmailAddress === '<?php echo esc_js( $current_email_address ); ?>' ) {
                closeModal();
                return;
            }
            ...
            $.ajax( {
                ...
                method    : 'POST',
                data      : {
                    action: '<?php echo esc_js( $fs->get_ajax_action( 'update_email_address' ) ); ?>',
                    security: '<?php echo esc_js( $fs->get_ajax_security( 'update_email_address' ) ); ?>',
